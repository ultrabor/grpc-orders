...
type OrderServiceClient interface {
	...
	ListOrders(ctx context.Context, in *Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[OrderResponse], error)
}
...
func (c *orderServiceClient) ListOrders(ctx context.Context, in *Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[OrderResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &OrderService_ServiceDesc.Streams[0], OrderService_ListOrders_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[Empty, OrderResponse]{ClientStream: stream}
...
type OrderService_ListOrdersClient = grpc.ServerStreamingClient[OrderResponse]
...
type OrderServiceServer interface {
	...
	ListOrders(*Empty, grpc.ServerStreamingServer[OrderResponse]) error
...
func (UnimplementedOrderServiceServer) ListOrders(*Empty, grpc.ServerStreamingServer[OrderResponse]) error {
...
func _OrderService_ListOrders_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(OrderServiceServer).ListOrders(m, &grpc.GenericServerStream[Empty, OrderResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type OrderService_ListOrdersServer = grpc.ServerStreamingServer[OrderResponse]
